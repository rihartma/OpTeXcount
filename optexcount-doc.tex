...
User can also use {\Blue `-verbose`} specifier. The source code will be printed on the screen with colored words, so you can easily see, what is considered as text word, header word, caption word, keyword etc.
